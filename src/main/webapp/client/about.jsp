...
<body class="button-custom layout-full-width ">
	<div id="Wrapper">
		...
		<div id="Content">
			<div style="padding-top:80px;padding-bottom:60px;background-color:#2a2a2a">
				<div class="container">
					<div class="row">
						<div class="col-md-4">
						...
						<div class="col-12">
							<hr class="no_line" style="margin: 0 auto 10px auto" /> </div>
						<div class="col-md-3">
							<div class="placeholder"> </div>
						</div>
						<div class="col-md-6">
							<div class="text-center">
								<h5>En Quispe Walker, nos apasiona el whisky. Ofrecemos una selección exclusiva de las mejores marcas y ediciones. <br> Nuestro equipo de expertos está aquí para guiarte en tu viaje por el mundo del whisky, ya seas un conocedor o un entusiasta. Únete a nosotros y descubre por qué el whisky es más que una bebida; es una experiencia.</h5> </div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="section mcb-section equal-height-wrap" style="padding-top:80px;padding-bottom:50px">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-7 column-margin-0px valign-middle clearfix">
							<div class="row">
								<div class="col-12">
						...
						<div class="col-md-5 column-margin-20px valign-middle clearfix" style="margin-top: 50px;">
							<div class="row">
								<div class="col-12">
									<div class="column_attr clearfix align_center">
										<h3>Elixir de Sabores</h3> </div>
								</div>
								<div class="col-12">
									<div class="image_frame image_item no_link scale-with-grid aligncenter no_border">
										<div class="image_wrapper"><img class="scale-with-grid" src="imgs/SimbolSignatureModel1.png" alt="" style="width: 100px; height: auto; margin-botom: 10px"/> </div>
								...
								<div class="col-12">
									<div class="column_attr clearfix align_center">
										<br>
										<p> Ofrecemos una selección exclusiva de las mejores marcas y ediciones. Nuestro equipo de expertos está aquí para guiarte en tu viaje por el mundo del whisky, ya seas un conocedor o un entusiasta.  </p>
										<p> Únete a nosotros y descubre por qué el whisky es más que una bebida; es una experiencia. </p>
									</div>
								</div>
								<div class="col-12">
									<div class="image_frame image_item no_link scale-with-grid aligncenter no_border">
			...
			<div class="section mcb-section equal-height-wrap" style="padding-top:100px;padding-bottom:60px;background-color:#2a2a2a">
				<div class="container">
					<div class="row">
